class Sequence(object):  												# Class to represent a DNA sequence.
	...
	def mutate_nucleotide_at_position(self, position, nucleotide):  	# Mutate the nucleotide at a specified position and update the mutation count.
...
def main():  # Main function to demonstrate the Sequence class
